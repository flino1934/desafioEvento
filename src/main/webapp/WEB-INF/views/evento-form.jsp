		...
		<form:form action="saveEvento" modelAttribute="evento" method="POST">
			...
			<div class = "form-row">
				...
				<div class = "form-group col-md-12">
					...
					<form:input class = "form-control" placeholder = "Descrição" path="descricaoEvento" />
				...
				<div class="form-group col-md-6">
					...
					<label>Preco</label>
					<form:input class="form-control" placeholder="Preço R$" path="preco" />
				...
				<div class="form-group col-md-6">
					...
					<form:input class="form-control" placeholder="Endereço" path="endereco" />
