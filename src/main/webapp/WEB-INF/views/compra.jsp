...
<body>
	...
	<div class="container">
		...
		<form:form action="saveCompra" modelAttribute="compra" method="POST">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					...
					<form:input class="form-control" placeholder="" path="quantidade" />
			...
			<button type="submit" class="btn btn-outline-primary"
				onclick="if(!(confirm('Deseja efetuar a compra?'))) return false">Comprar</button>
