...
<title>Lista de casa de shows</title>
...
<body>
	...
	<table class="table table-hover table-bordered">
		...
		<c:forEach var="tempCasa" items="${casa}">



			<c:url var="deleteLink" value="/casaDeShow/delete">

				<c:param name="casaId" value="${tempCasa.id}"></c:param>

			</c:url>


			<tr>
				<td>${tempCasa.nomeCasaShow}</td>
				<td>${tempCasa.endereco}</td>
				<td>${tempCasa.cep}</td>
				<td>${tempCasa.descricao}</td>
				<td>${tempCasa.capacidade}</td>
				<td>${tempCasa.valorAluguel}</td>
